...
import type { YoutubeVideoReference } from './contracts.js';
...
export function parseYoutubeVideoUrl(input: string): YoutubeVideoReference {
...
function reference(videoId: string): YoutubeVideoReference {
...
function invalidUrl(): YoutubeAudioError {
